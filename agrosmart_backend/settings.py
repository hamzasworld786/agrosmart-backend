"""
Django settings for agrosmart_backend project.
...
SECRET_KEY = 'django-insecure-(f261914@m5w%t5(&s62jnc(k)@!bum1&j&b5t5$hz=^$e4sf#'
...
ROOT_URLCONF = 'agrosmart_backend.urls'
...
WSGI_APPLICATION = 'agrosmart_backend.wsgi.application'
